...
with_dynamic_location_id_whole_test_path = data_conf.with_dynamic_location_id_whole_test_path
simple_location_id_whole_test_path = data_conf.simple_location_id_whole_test_path
...
def extract_compete_queue_info():
    ...
    final_select_test_request_df[convert_dtype_columns] = final_select_test_request_df[
        convert_dtype_columns].astype(
        int, inplace=True)
    ...
    # print('final_select_test_request_df_with_track_df   ', final_select_test_request_df.shape)

    # final_select_test_request_df_with_track_df.drop( ['request_id'] , axis =1 , inplace = True)
    # del final_select_test_request_df_with_track_df['request_id']
    # gc.collect()

    print(final_select_test_request_df_with_track_df.head())
    print(final_select_test_request_df_with_track_df.isnull().sum())

    final_select_test_request_df_with_track_df.to_csv(with_dynamic_location_id_whole_test_path, index=None)
...
def get_model_test_data():
    ...
    # else:
    if os.path.exists(with_dynamic_location_id_whole_test_path):
        ...
        final_select_test_request_df_with_track_df = pd.read_csv(with_dynamic_location_id_whole_test_path)
    ...
    with_num_of_opponents_track_df = extract_test_track_log_num_of_opponents(final_select_test_request_df_with_track_df)

    ad_static_df = read_ad_static_data(ad_static_path=ad_static_path)
    ...
    simple_whole_test_data.to_csv(simple_location_id_whole_test_path, index=None)
